...
<head>
  ...
  <title>Edit Data Tamu Wisma Anggrek | LPMP Kalbar</title>
  <!-- plugins:css -->
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="row mb-0">
            <div class="col-md-12 mb-md-2 mb-0 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold text-md-left text-center">Form Edit Kamar Anggrek</h3>
                </div>
              </div> 
            </div>
          </div>
