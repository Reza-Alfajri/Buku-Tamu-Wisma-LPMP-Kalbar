                                    ...
                                    <?php if($list['nik'] && $list['nik2']) {?> 
                                        ...
                                        <td>
                                            ...
                                            <?php 
                                                if($list['statusco']=="Kosong") 
                                                    echo 
                                                    "<a href=../../proses-hapus-anggrek.php?nomor_kamar1=".$list['nomor_kamar']." onclick='return hapus(event)' class='disable'>
                                                    <span aria-hidden='true'><i class='fa fa-times-circle'></i></span>Check Out
                                                    </a>";
                                                else 
                                                    echo 
                                                    "<a href=../../proses-hapus-anggrek.php?nomor_kamar1=".$list['nomor_kamar']." onclick='return hapus(event)'>
                                                    <span aria-hidden='true'><i class='fa fa-times-circle'></i></span>Check Out
                                                    </a>";
                                            ?>
                                            <script type="text/javascript">
                                            ...
                                            <?php 
                                                if($list['statusco']=="Kosong") 
                                                    echo 
                                                    "<a href=../../proses-hapus-anggrek.php?nomor_kamar2=".$list['nomor_kamar']." onclick='return hapus(event)' class='disable'>
                                                    <span aria-hidden='true'><i class='fa fa-times-circle'></i></span>Check Out
                                                    </a>";
                                                else 
                                                    echo
                                                    "<a href=../../proses-hapus-anggrek.php?nomor_kamar2=".$list['nomor_kamar']." onclick='return hapus(event)'>
                                                    <span aria-hidden='true'><i class='fa fa-times-circle'></i></span>Check Out
                                                    </a>";
                                            ?>
                                            <script type="text/javascript">
					...
					<?php } else if( $list['nik2']) {?> 
                                        ...
                                        <td>
                                            <?php 
                                                if($list['statusco']=="Kosong") 
                                                    echo 
                                                    "<a href=../../proses-hapus-anggrek.php?nomor_kamar=".$list['nomor_kamar']." onclick='return hapus(event)' class='disable'>
                                                    <span aria-hidden='true'><i class='fa fa-times-circle'></i></span>Check Out
                                                    </a>";
                                                else 
                                                    echo 
                                                    "<a href=../../proses-hapus-anggrek.php?nomor_kamar=".$list['nomor_kamar']." onclick='return hapus(event)'>
                                                    <span aria-hidden='true'><i class='fa fa-times-circle'></i></span>Check Out
                                                    </a>";
                                            ?>
                                            <script type="text/javascript">
