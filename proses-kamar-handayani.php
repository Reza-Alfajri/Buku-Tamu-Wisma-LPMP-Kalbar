<?php
    ...
    if(isset($_POST['simpan'])){
        ...
        $sql1 = "INSERT INTO rekapan (timestamp, nama_kegiatan, tanggal_awal, tanggal_akhir, nama_tamu, nik, jenis_kelamin, tanggal_lahir, kota, jabatan, nama_kantor, no_hp, wisma, nomor_kamar)
        VALUE ('$timestamp', '$nama_kegiatan', '$tanggal_awal', '$tanggal_akhir', '$nama_tamu', '$nik', '$jenis_kelamin', '$tanggal_lahir', '$kota', '$jabatan', '$nama_kantor', '$no_hp', '$wisma', '$nomor_kamar')";
