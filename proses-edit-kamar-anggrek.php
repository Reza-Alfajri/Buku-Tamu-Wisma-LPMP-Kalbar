<?php
    ...
    if(isset($_POST['simpan'])){
        ...
        nik='$nik', nama_tamu='$nama_tamu', jenis_kelamin='$jenis_kelamin', tanggal_lahir='$tanggal_lahir', kota='$kota', jabatan='$jabatan', nama_kantor='$nama_kantor', no_hp='$no_hp', nomor_kamar='$nomor_kamar' WHERE nik='$nik'";
