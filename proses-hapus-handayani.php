<?php
    ...
    if(isset($_GET['nomor_kamar1'])){
        ...
        $sql = "UPDATE handyani SET timestamp='$timestamp', nama_kegiatan='$nama_kegiatan', tanggal_awal='$tanggal_awal', tanggal_akhir='$tanggal_akhir',
        ...
        //apakah query berhasil tersimpan
        if( $query && $query1 ){
            header('Location: pages/list-kamar/list-kamar-handyani.php');
        } else {
            die("Gagal menyimpan perubahan...");
        }
    } else {
